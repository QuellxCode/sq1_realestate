...
<div class="all-wrapper rentals">
  ...
  <div class="property-single">
        <div class="property-media" style="background-image: url('{{ url($condo_property->feature_image)}}')">
        ...
        <div class="property-info-w">
            <div class="property-info-main">
                <div class="badge badge-red">
                    {{ $properties->property->availiable }}
                </div>
                ...
                <div class="property-price">
                    <strong>${{ $properties->condo($properties->id)->price_from }}</strong><span>Listing Price</span>
                </div>
                <div class="item-reviews">
                    ...
                    <div class="property-features-highlight">
                        <div class="feature">
                            <i class="os-icon os-icon-home-34"></i><span>{{ $condo_property->floors }} Floors</span>
                        </div>
                        <div class="feature">
                            <i class="os-icon os-icon-home-13"></i><span>{{ $condo_property->sqft }} SQFT</span>
                        </div>
                        <div class="feature">
                            <i class="os-icon os-icon-home-09"></i><span>{{ $condo_property->model }} Model</span>
                        </div>
                        <div class="feature">
                            <i class="os-icon os-icon-ui-83"></i><span>{{ $condo_property->features }} Features</span>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('campaign-leads/'.strtr(base64_encode($properties->property->id), '+/=', '._-')) }}" id="formValidate" method="post" enctype="multipart/form-data">
...
<script>
    ...
    function initialize() {
        var bangalore = { lat: <?php echo $properties->property->latitude ?>, lng: <?php echo $properties->property->longitude ?> };
