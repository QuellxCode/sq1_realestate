                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($photos as $value)
                                        <tr>
                                            ...
                                            <td colspan="3"><img src="{{ url($value->photo) }}" width="500px" height="300px"/></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('properties-photos-upload/'.$property_id) }}" id="formValidate" method="post" enctype="multipart/form-data">
