                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tbody>
                                    @foreach($condo_images as $value)
                                        <tr>
                                            <td><strong><small class="text-danger">Images</small></strong></td>
                                            <td colspan="3"><img src="{{ url($value->image) }}" width="100px" height="100px"/></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/condo/image-upload/'.$id) }}" id="formValidate" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />

                        <div class="form-group">
                            <label for="">Upload Picture</label>
                            <input class="form-control" required="required" type="file" name="image[]" multiple>
