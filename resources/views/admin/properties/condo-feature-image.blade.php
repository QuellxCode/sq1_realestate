        ...
        <div class="content-box">
            <div class="element-wrapper">
                <h6 class="element-header">
                    Condo Properties Feature Image
                </h6>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <tbody>
                                    <tr>
                                        @if(isset($condo_images->feature_image))
                                            <td colspan="3"><img src="{{ url($condo_images->feature_image) }}"/></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/condo/feature-image-upload/'.$condo_images->id) }}" id="formValidate" method="post" enctype="multipart/form-data">
