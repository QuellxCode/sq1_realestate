            ...
            <div class="element-wrapper">
                ...
                <div class="element-box">
                    <h5 class="form-header">
                        <a href="{{ url('unit-create') }}" class="mr-2 mb-2 btn btn-success" > Add Unit</a>
                    </h5>
                                ...
                                <tr>
                                    ...
                                    <td><div class="btn-group mr-1 mb-1">
                                            ...
                                            <div aria-labelledby="dropdownMenuButton1" class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{ url('unit-delete/'.$value->id) }}"> Delete</a>
                                                <a class="dropdown-item" href="{{ url('unit-update/'.$value->id) }}"> Update</a>
                                            </div>
                                        </div></td>
                                </tr>
                            @endforeach
