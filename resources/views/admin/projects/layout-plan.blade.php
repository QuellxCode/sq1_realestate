            ...
            <div class="element-wrapper">
                ...
                <div class="element-box">
                    ...
                    <h5 class="form-header">
                        ...
                        <a href="{{ url('projects') }}" class="btn btn-success"> Back</a>
                    </h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    @foreach($photos as $value)
                                        <tr>
                                            <td><strong>
                                                    <small class="text-danger">Photo</small>
                                                </strong></td>
                                            <td colspan="3"><img src="{{ url($value->photo) }}"/></td>
                                            <td colspan="3"><a href="{{ url('project-layout-plan-delete/'.$value->id) }}" class="btn btn-danger"> Delete</a>
                                            </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('project-layout-plan-upload/'.$project_id) }}" id="formValidate" method="post" enctype="multipart/form-data">
