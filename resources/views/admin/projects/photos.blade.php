                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($photos as $value)
                                        <tr>
                                            ...
                                            <td colspan="3"><a href="{{ url('project-photos-delete/'.$value->id) }}" class="btn btn-danger"> Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody></table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('project-photos-upload/'.$project_id) }}" id="formValidate" method="post" enctype="multipart/form-data">
